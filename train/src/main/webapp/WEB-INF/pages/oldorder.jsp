...
<div class="container">
    <h3 style="text-align: center">车票历史票模块</h3>
    ...
    <form id="trainlist_form" name="form" action="${pageContext.request.contextPath}/order/orderdeal" >
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${sessionScope.oldorders}" var="oldorder">
                <tr>
                    ...
                    <td>出发时间：${oldorder.train.printtime()}<br>
                    出发站：${oldorder.train.train_start}<br>
                    终点站：${oldorder.train.train_end}
                    类型：${oldorder.train.train_type}</td>
                    <td>${oldorder.order_number}</td>
